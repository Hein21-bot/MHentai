<template>
  <div class="space-y-5">
    ...
    <!-- Empty -->
    <div v-else-if="results.length === 0" class="py-20 text-center text-gray-400 dark:text-gray-600">
    ...
    <template v-else>
      ...
      <p class="text-sm text-gray-500 dark:text-gray-500">
        <span class="font-semibold text-gray-900 dark:text-white">{{ total }}</span> series
...
async function load() {
  ...
  try {
    ...
    if (activeLetter.value) params.letter = activeLetter.value
